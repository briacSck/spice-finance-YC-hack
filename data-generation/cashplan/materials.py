...
MATERIALS: dict[str, Material] = {
    ...
    "polymer_resin": Material(
        ...
        volatility=0.09,
        source="INSEE Brent proxy for oil-linked polymer resin",
    ...
    "polyurethane": Material(
        ...
        default_unit_price=2.80,
        volatility=0.06,
        source="INSEE Brent proxy for oil-linked chemical inputs",
    ...
    "cardboard_packaging": Material(
        ...
        family="packaging",
        underlying="Wood",
        market_code="PACKAGING_PAPER",
        default_unit="unit",
        default_unit_price=7.50,
        volatility=0.04,
        source="INSEE paper/cardboard packaging proxy",
