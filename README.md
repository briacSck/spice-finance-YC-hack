...
| Path | What |
|---|---|
| [`business/BRIEF.md`](business/BRIEF.md) | Idea, insight, beachhead, moat |
| [`business/COMPETITION.md`](business/COMPETITION.md) | Competitive whitespace map |
| [`business/UNIT_ECONOMICS.md`](business/UNIT_ECONOMICS.md) | Source-backed per-client revenue model + GTM revenue ramp (500 → France → EU → TAM) |
| [`business/MARKET_SIZING.md`](business/MARKET_SIZING.md) | TAM/SAM/SOM tables + cited sources [S1]–[S17] |
